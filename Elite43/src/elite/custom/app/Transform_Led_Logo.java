...
public class Transform_Led_Logo extends Animation {
	...
	public Transform_Led_Logo(boolean bool) {
		bg = bool;
	}
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
		...
		MainActivity.led_slide_logo.setLayoutParams(layout_video_image);
		MainActivity.led_slide_logo.requestLayout();
	}
    ...
    public void initialize(int width, int height, int parentWidth, int parentHeight) {
		...
		logo_w = MainActivity.led_slide_logo_layout.getWidth();
		logo_h = MainActivity.led_slide_logo_layout.getHeight();
	}
