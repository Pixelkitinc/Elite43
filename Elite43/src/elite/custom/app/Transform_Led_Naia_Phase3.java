...
public class Transform_Led_Naia_Phase3 extends Animation {
	private int initialWidth;
	private int newWidth;
	private boolean bg;
	
	/**
	 * Transform_Led_Naia_Phase3
	 * 
	 * @param bool
	 * 
	 * */
	...
	public Transform_Led_Naia_Phase3(boolean bool) {
		bg = bool;
	}
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
		...
		MainActivity.led_naia_info_layout.setLayoutParams(layout_main);
		MainActivity.led_naia_info_layout.requestLayout();
	}
