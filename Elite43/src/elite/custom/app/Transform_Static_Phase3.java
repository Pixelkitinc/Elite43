...
public class Transform_Static_Phase3 extends Animation {
	private int initialWidth;
	private int newWidth;
	private boolean bg;
	
	/**
	 * Transform_Static_Phase3
	 * 
	 * @param bool
	 * 
	 * */	
	public Transform_Static_Phase3(boolean bool) {
		bg = bool;
	}
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
		...
		MainActivity.static_info_layout.setLayoutParams(layout_main);
		MainActivity.static_info_layout.requestLayout();
	}
    ...
    public void initialize(int width, int height, int parentWidth, int parentHeight) {
        ...
        initialWidth = MainActivity.static_slide_layout.getWidth();
	}
